  ...
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-1 px-3 d-flex ai-center text-white">
      ...
      <div class="px-2 flex-1">
        ...
        <span class="ml-2">456</span>
      </div>  
      <router-link to="/" tag="div">更多 &gt;</router-link>  
    </div>
