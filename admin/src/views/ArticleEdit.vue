    ...
    methods:{
      ...
      Editor.insertEmbed(cursorLocation, "image", res.data.url);
        ...
        async save(){
            ...
            if(this.id){
                const res = await this.$http.put(`rest/articles/${this.id}`,this.model)// eslint-disable-line no-unused-vars
            }else{
                const res = await this.$http.post('rest/articles',this.model)// eslint-disable-line no-unused-vars
            }
