...
export default {
    ...
    methods:{
        async save(){
            ...
            if(this.id){
                const res = await this.$http.put(`rest/ads/${this.id}`,this.model)// eslint-disable-line no-unused-vars
            }else{
                const res = await this.$http.post('rest/ads',this.model)// eslint-disable-line no-unused-vars
            }
