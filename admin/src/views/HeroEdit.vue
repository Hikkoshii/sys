  ...
  <div class="about">
    ...
    <el-form label-width="120px" @submit.native.prevent="save">
        ...
        <el-form-item label="难度">
            <el-rate style="magin-top:0.6rem" :max="9" show-score v-model="model.scores.difficult"></el-rate>
        </el-form-item>  
        <el-form-item label="技能">
            <el-rate style="magin-top:0.6rem" :max="9" show-score v-model="model.scores.skills"></el-rate>
        </el-form-item>  
        <el-form-item label="攻击">
            <el-rate style="magin-top:0.6rem" :max="9" show-score v-model="model.scores.attack"></el-rate>
        </el-form-item>  
        <el-form-item label="生存">
            <el-rate style="magin-top:0.6rem" :max="9" show-score v-model="model.scores.survive"></el-rate>
        </el-form-item>  
...
export default {
    ...
    methods:{
        async save(){
            ...
            if(this.id){
                const res = await this.$http.put(`rest/heroes/${this.id}`,this.model)// eslint-disable-line no-unused-vars
            }else{
                const res = await this.$http.post('rest/heroes',this.model)// eslint-disable-line no-unused-vars
            }
